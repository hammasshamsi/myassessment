...
Route::prefix('onboarding')->group(function () {
    ...
    Route::get('/step-2', [Step2Controller::class, 'show'])->name('onboarding.step2');
    Route::post('/step-2', [Step2Controller::class, 'store']);

    Route::get('/step-3', [Step3Controller::class, 'show'])->name('onboarding.step3');
    Route::post('/step-3', [Step3Controller::class, 'store']);

    Route::get('/step-4', [Step4Controller::class, 'show'])->name('onboarding.step4');
    Route::post('/step-4', [Step4Controller::class, 'store']);

    Route::get('/step-5', [Step5Controller::class, 'show'])->name('onboarding.step5');
